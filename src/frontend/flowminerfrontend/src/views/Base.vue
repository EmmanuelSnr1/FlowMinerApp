  ...
  <main class="p-4 md:ml-64 h-auto pt-20">
    <div>
      ...
      <div class="container mx-auto px-4">
        ...
        <section id="Statistics Summary" class="">
          <h1
          ...
          <p class="mb-6 text-lg text-center font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
            Statistics of recent Jobs and So on.
          </p>
                ...
                <div class="flex justify-between items-center pt-5">
                  ...
                  <div id="lastDaysdropdown"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                      ...
                      <li>
                        <a href="#"
                          class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Last 6
                          months</a>
                      </li>
                      <li>
                        <a href="#"
...
<script>
import ApexCharts from "apexcharts"; // Import ApexCharts library (if not already done)

export default {
  mounted() {
    // Check if the element exists and ApexCharts is available
    if (
      document.getElementById("bar-chart", "donut-chart") &&
